...
<a href="/organization/users" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-user-shield"></i>
    </div>
    <div class="settings-title">Loan Consultants</div>
    <div class="settings-desc">Manage loan consultants across branches</div>
</a>
...
<a href="{{ route('client-assets.index') }}" class="settings-card">
    ...
    <div class="settings-title">Client Assets</div>
    <div class="settings-desc">
        Manage client assets including collateral collections and pledged items
    </div>
</a>

<a href="{{ route('branches.index') }}" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-code-branch"></i>
    </div>
    <div class="settings-title">Branches</div>
    <div class="settings-desc">
        Manage organization branches, locations & operational assignments
    </div>
</a>

@can('view organization settings')
<a href="{{ route('settings.organization.edit') }}" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-building"></i>
    </div>
    <div class="settings-title">Organization Settings</div>
    <div class="settings-desc">
        Configure organization preferences, policies, and system defaults
    </div>
</a>
@endcan
...
<a href="{{ route('integrations.api') }}" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-plug"></i>
    </div>
    <div class="settings-title">API Integrations</div>
    <div class="settings-desc">
        Manage API keys, external integrations, and system connectivity
    </div>
</a>

<a href="hh" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-book-open"></i>
    </div>
    <div class="settings-title">API Documentation</div>
    <div class="settings-desc">
        View system API endpoints, usage guides, and integration instructions
    </div>
</a>
...
<a href="gg" class="settings-card">
    ...
    <div class="settings-title">Payments Report</div>
    <div class="settings-desc">
        View and analyze payment transactions across branches
    </div>
</a>

<a href="/reports/loans" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-chart-line"></i>
    </div>
    <div class="settings-title">Loans Reports</div>
    <div class="settings-desc">
        Check Reports for Loans Categories
    </div>
</a>

<a href="{{ route('expenses.index') }}" class="settings-card">
    <div class="settings-icon" style="background: {{ $iconColors[$i++ % 3] }}">
        <i class="fas fa-receipt"></i>
    </div>
    <div class="settings-title">Expenses</div>
    <div class="settings-desc">
        Manage organization & branch expenses
    </div>
</a>
