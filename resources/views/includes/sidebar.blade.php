...
<style>
  :root {
    --sb-bg: #262626;            /* deep blue background */
    --sb-hover-bg: #343434;      /* green hover */
    --sb-text: #ffffff;          /* white text */
    --sb-icon: #989898;          /* bright green icons */
    --sb-border: #444444;        /* dark blue border */
  }
...
<li>
    <a href="{{ route('privacy.show') }}"
       class="{{ request()->routeIs('privacy.show') ? 'active' : '' }}">
        ...
        <span>API Documentation</span>
            ...
            @php
                ...
                $avatarUrl = auth()->user()->profile_image
                    ...
                    : 'https://ui-avatars.com/api/?name=' . urlencode($userName) . '&color=FFFFFF&background=989898';
            @endphp
